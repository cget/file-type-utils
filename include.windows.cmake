...
FUNCTION(CGET_DLL2LIB DLL OUTPUT_LOCATION)
    ...
    CGET_EXECUTE_PROCESS(COMMAND cmd /c "${DIR_OF_FILE_TYPE_UTILS_WIN}/dll2lib.bat" "${CGET_ARCH}" "${CGET_TEMP_DIR}/${NAME}.dll" "${DUMPBIN}" "${LIB_CMD}" WORKING_DIRECTORY "${CGET_INSTALL_ROOT}/lib")    
...
FUNCTION(CGET_GET_MSVC_RUNTIME name var)
    ...
    message("No runtime match: ${OUTPUT}")           
ENDFUNCTION()
...
function(CGET_FILTER_BY_RUNTIME OUTPUT libraries RUNTIME_MATCH)
    ...
    foreach(DLL ${LOCAL_LIST})   
        ...
        if(NOT "${RUNTIME}" MATCHES "${RUNTIME_MATCH}")
