...
FUNCTION(CGET_GET_FILE_ARCH name var)
    ...
    elseif(OUTPUT MATCHES "8664 machine .x64.")
        ...
        message(FATAL_ERROR "Unexpected output for ${name}: ${OUTPUT}")
    endif()
ENDFUNCTION()
...
function(CGET_CHECK_IF_FILE_IS_COMPATIBLE library rtn)
...
function(CGET_FILTER_INCOMPATIBLE libraries)
    CGET_MESSAGE(17 "Checking ${${libraries}} for compatible files")
    foreach(DLL ${${libraries}})
        CGET_CHECK_IF_FILE_IS_COMPATIBLE("${DLL}" IS_COMPATIBLE ${ARGN})
        if(NOT IS_COMPATIBLE)
            list(REMOVE_ITEM ${libraries} "${DLL}")
        else()
            CGET_MESSAGE(17 "File '${DLL}' is compatible")
        endif()
    endforeach()
endfunction()