...
function(CGET_COPY_DEPENDENCIES_LOCAL target)
	...
	string(REPLACE ";" "\;" SAFE_PREFIX_PATH "${CMAKE_PREFIX_PATH}")
		...
		add_custom_command(TARGET ${target} POST_BUILD
		  ...
		  -DINSTALL_SCRIPT="${CMAKE_CURRENT_BINARY_DIR}/bundle_install.cmake"
		  -DCMAKE_PREFIX_PATH="${SAFE_PREFIX_PATH}" "-DCMAKE_LIBRARY_PATH=\"${CMAKE_LIBRARY_PATH}\""
		  -DTARGET=\"${TARGET_FILE}\"
		  -DDIR="${CGET_INSTALL_DIR}/\;${CMAKE_LIBRARY_PATH}\;"
		  -P "${CGET_COPY_DEPENDENCIES_LOCAL_FILE}"
